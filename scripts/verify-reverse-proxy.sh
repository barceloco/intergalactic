...
echo ""
ssh -i "${SSH_KEY}" ansible@${HOST} "dig @127.0.0.1 mpnas.exnada.com +short"
ssh -i "${SSH_KEY}" ansible@${HOST} "dig @127.0.0.1 aispector.exnada.com +short"
ssh -i "${SSH_KEY}" ansible@${HOST} "dig @127.0.0.1 dev.exnada.com +short"
echo ""

echo "[6/8] Testing DNS forwarding (should resolve to public IP)..."
ssh -i "${SSH_KEY}" ansible@${HOST} "dig @127.0.0.1 www.exnada.com +short"
echo ""
...
echo "   dig mpnas.exnada.com"
echo "   dig aispector.exnada.com"
echo "   dig dev.exnada.com"
echo ""
echo "2. Test HTTPS routing (from a machine with Tailscale access):"
echo "   curl -k https://mpnas.exnada.com/health"
echo "   curl -k https://aispector.exnada.com/health"
echo "   curl -k https://dev.exnada.com/health"
echo ""
